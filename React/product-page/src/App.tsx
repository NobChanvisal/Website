...
function App() {
  // Set the products state with type Product[]
  ...
  return (
    <div className="product-list container-xl mx-auto py-10 px-20">
      {products.map((product: Product) => (
        <div key={product.id} className="product-card grid grid-cols-2">
          <div className="product-image place-self-center">
            <div
          ...
          <div className="product-info pl-6">
            <nav className="w-max mb-2" aria-label="breadcrumb">
              <ol className="flex w-full flex-wrap items-center text-sm">
                <li className="breadcrumb-item ">
                  <a className="text-slate-500 pr-2">{product.company}</a>
                </li>
                <li className="breadcrumb-item">
            ...
            <div className="size-content flex flex-wrap pt-3">
              <p className=" font-semibold">Select Size</p>
              <div>
                {product.size.map((sizes) => (
                  <button className="py-1 px-5 mr-2 mt-2 rounded-sm border-1 hover:border-black">
                    {sizes}
                  </button>
                ))}
              </div>
