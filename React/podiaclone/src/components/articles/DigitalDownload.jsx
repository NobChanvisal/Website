      ...
      <section>
        <div className="container">
          <div className=" grid grid-cols-[34.5%_minmax(0,1fr)] p-10 bg-[#f5efeb] gap-x-11 rounded-xl">
            ...
            <div className="text-component">
              <p className="heading-text mb-1">Digital products platform</p>
              <h2 className=" title-section mb-4 mt-3">
                Start selling digital downloads for free
              </h2>
              <div className="section-description">
                <p>
                  "I love using Podia for my small business! As a dietitian,
                  having little to no sales or marketing experience, I find that
                  the Podia platform is extremely user-friendly and makes
                  publishing my online courses, digital downloads and coaching
                  sessions a breeze!"
                </p>
              </div>
              <p className=" text-[15px] text-[#5c5856]">
                – Sara Cammorata, Sara Cammo Nutrition
              </p>
              <button className="mt-4 px-6 py-2 text-[20px] font-bold text-white bg-[#4b2aad] rounded-3xl transition-all hover:bg-[#201445]">
                Get start now
              </button>
