  ...
  return (
    <div className="bg-white">
      ...
      <header className="relative bg-white">
        ...
        <nav aria-label="Top" className="mx-auto max-full px-2 sm:px-6 lg:px-8">
          <div className="border-b border-gray-200">
            <div className="flex h-16 flex-row items-center justify-center">
              {/* Logo */}
              <div className="flex p-2 sm:w-[200px] lg:ml-0">
                <a className=" flex items-center" href="#">
                <BugAntIcon className=" w-6 h-6 text-blue-500"/>
                  <span className=" pl-1 hidden sm:inline">NC.VISAL</span>
                  {/* <img
                    alt=""
              ...
              <div className="flex items-center justify-end flex-1 lg:max-w-sm">
                ...
                {/* Search */}
                <div className="flex flex-row items-center flex-1 px-2 py-2 bg-slate-50 rounded-md  lg:ml-6">
                  <MagnifyingGlassIcon
                    aria-hidden="true"
                ...
                >
                  ...
                  <Bars3Icon aria-hidden="true" className=" h-5 w-5 sm:h-6 sm:w-6 mt-1" />
                </button>
              </div>
            </div>
          </div>
